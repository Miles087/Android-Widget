...
/**
 * 用途：声波传送消息 滴滴滴
 * 作者：Created by Miles Wang on 2019/1/31
 * 邮箱：icy-star@qq.com
 **/
public class SoundPassMessage extends Activity implements SinVoiceRecognition.Listener, SinVoicePlayer.Listener {

    private final static String TAG = "SoundPassMessage";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sound_pass_message);
    ...
    private static class RegHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_RECG_END:
                    com.libra.sinvoice.LogHelper.d(TAG, "recognition end");
                    break;
            }
    ...
    public void onPlayStart() {
        com.libra.sinvoice.LogHelper.d(TAG, "start play");
    }

    @Override
    public void onPlayEnd() {
        com.libra.sinvoice.LogHelper.d(TAG, "stop play");
    }
}
